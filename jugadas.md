...
**Objetivo:** Generar un 3 vs 2 en mitad de cancha.

**Descripción:**
La jugada Bulita busca crear una superioridad numérica con el apertura, primer centro y wing ciego contra el apertura y primer centro rival.

**Ejecución:**
1. El apertura debe fijar a su rival directo
2. El primer centro compromete a su centro rival y busca un ángulo corto al hombro interno, bien plano
3. El wing ciego permanece en la espalda del apertura hasta último momento para no ser detectado
4. Cuando el primer centro cambia de ángulo, el wing ciego se muestra
5. El segundo centro debe abrir al segundo centro rival para aislar el 3 vs 2
...
**Descripción:**
Jugada con tres variantes que comparten la base pero difieren en el movimiento del wing ciego.
...
3. El apertura debe seguir moviendo las piernas después del cruce para abrir espacio

**Variante MACA:**
- El wing ciego va en cruce después de que pase el primer centro

**Variante POMELO:**
- El wing ciego va por espalda del segundo centro

**Clave:** Las tres opciones (primer centro, segundo centro, wing) deben ser posibles casi al mismo momento.
...
3. El segundo centro cruza por atrás de ambos
...
3. Pase al wing ciego (superioridad numérica exterior si el 2do centro rival se cierra)

---

### Boca

**Dirección:** SIEMPRE de izquierda a derecha para evitar marcación del 9 rival.

**Descripción:**
Los centros corren carreras casi idénticas: rectas hasta la defensa, buscando espacio a último momento.

**Ejecución:**
1. El 10 debe preocupar al primer centro rival
2. Los centros corren carreras rectas y paralelas
...
**Ejecución:**
1. El apertura juega con el primer centro
...
**Dirección:** SIEMPRE de derecha a izquierda para evitar marcación del 9 rival.
...
**Opciones:**
- Wing ciego puede pasar al 2do centro
